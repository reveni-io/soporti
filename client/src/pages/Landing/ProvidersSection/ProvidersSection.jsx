  ...
  return (
    <Section id="providers" className="lp-section--cool">
      <div className="lp-section__head">
        ...
        <p className="lp-lead">
          Pick the provider in <strong>/admin</strong>, paste its API key and choose the model. Credentials live in your
          own database — never an env var — and switching provider takes effect on the next message, with no redeploy.
        </p>
      </div>
      <div className="lp-prov__grid">
        {LLM_PROVIDERS.map(provider => (
          <div className="lp-prov" key={provider.id}>
            ...
            <div className="lp-prov__models">{provider.models}</div>

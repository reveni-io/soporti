  ...
  return (
    <Section id="attachments" className="lp-section--warm">
      <div className="lp-section__head">
        ...
        <p className="lp-lead">
          Attach a PDF, a Word document or an Excel sheet from the composer and Soporti reads it as context for that
          conversation — tables and sheets included. No copy-pasting, no structure lost on the way.
        </p>
        <ul className="lp-points">
          <li>Up to {MAX_ATTACHMENTS} files per message, read the moment you attach them</li>

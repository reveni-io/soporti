...
import CustomInstructionsTab from './CustomInstructionsTab.jsx'
...
describe('CustomInstructionsTab', () => {
  ...
  it('renders the character count', async () => {
  ...
  it('calls onLogout when the load returns 401', async () => {
    ...
    render(<CustomInstructionsTab token="tok" onLogout={onLogout} />)

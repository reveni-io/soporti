...
vi.mock('./AdminAuthentication/AdminAuthentication.jsx', () => ({
  default: () => <div data-testid="admin-authentication" />,
}))

vi.mock('./AdminGithub/AdminGithub.jsx', () => ({
  default: () => <div data-testid="admin-github" />,
}))

vi.mock('./AdminGoogleDrive/AdminGoogleDrive.jsx', () => ({
  default: () => <div data-testid="admin-google-drive" />,
}))

vi.mock('./AdminNotion/AdminNotion.jsx', () => ({
  default: () => <div data-testid="admin-notion" />,
}))

vi.mock('./AdminHelpjuice/AdminHelpjuice.jsx', () => ({
  default: () => <div data-testid="admin-helpjuice" />,
}))

vi.mock('./AdminDatabase/AdminDatabase.jsx', () => ({
  default: () => <div data-testid="admin-database" />,
}))

vi.mock('./AdminShopify/AdminShopify.jsx', () => ({
...
vi.mock('./AdminSentry/AdminSentry.jsx', () => ({
  default: () => <div data-testid="admin-sentry" />,
}))

vi.mock('./AdminSlack/AdminSlack.jsx', () => ({

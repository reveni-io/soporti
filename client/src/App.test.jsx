...
vi.mock('./hooks/useAuthMethods.js', () => ({
...
describe('App', () => {
  ...
  it('opens sidebar overlay when Open Sidebar is clicked', async () => {
    ...
    expect(container.querySelector('.app__overlay')).toBeTruthy()
  ...
  it('closes sidebar when Close Sidebar button is clicked', async () => {
    ...
    expect(container.querySelector('.app__overlay')).toBeNull()
  ...
  it('closes sidebar when overlay is clicked', async () => {
    ...
    await user.click(screen.getByText('Open Sidebar'))
    const overlay = container.querySelector('.app__overlay')

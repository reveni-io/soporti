...
const TOOL_LABELS = {
  ...
  create_shortcut_story: { label: 'Creating Shortcut story', arg: 'name' },
  update_shortcut_story: { label: 'Updating Shortcut story', arg: 'storyId' },
  add_shortcut_comment: { label: 'Commenting on Shortcut story', arg: 'storyId' },
